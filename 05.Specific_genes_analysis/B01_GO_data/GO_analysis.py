...
def main(input, output):
    ...
    plt.title('Gene Distribution by GO classification', fontsize=16, fontweight='bold', pad=20)
    ...
    if both_gene_ids:
        ...
        report_list.append({
            ...
            'Representative genes/proteins': '; '.join(both_entries)
        })
    ...
    for display_name, gene_ids in go_to_proteins.items():
        ...
        report_list.append({
            ...
            'Representative genes/proteins': '; '.join(protein_entries)
        })
