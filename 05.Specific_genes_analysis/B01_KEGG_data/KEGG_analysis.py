...
def main(input, output):
    ...
    # palette = {'Stress Response': '#f6c7b3', 'Environmental Adaptation': '#b3d1e7', 'Both': '#acc791'}
    ...
    plt.tight_layout()
    plt.savefig('KEGG_barchart.png', dpi=300)
    ...
    if both_protein_entries:
        ...
        final_report_list.append({
            ...
            'Representative genes/proteins': '; '.join(unique_both)
        })
    ...
    for path_name, data in table_dict.items():
        ...
        final_report_list.append({
            ...
            'Representative genes/proteins': '; '.join(unique_prots)
        })
